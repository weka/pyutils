...
class RemoteServer():
    ...
    def connect(self):
        #self.connection = fabric.Connection(self._hostname)
        try:
            ...
            #self.connection.transport.auth_password(self.user, self.password)
            #self.connection.user = self.connection.ssh_config['user'] = self.user
            #self.connection.password = self.connection.ssh_config['password'] = self.password
            result = self.connection.open()
            #raise
